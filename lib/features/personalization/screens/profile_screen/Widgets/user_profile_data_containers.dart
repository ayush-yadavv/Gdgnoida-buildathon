...
import 'package:eat_right/features/personalization/controllers/user_profile_screen/user_profile_controller.dart';
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: Sizes.spaceBtwItems / 4),
            Text(
              '@$profileUsername',
              textAlign: TextAlign.start,
