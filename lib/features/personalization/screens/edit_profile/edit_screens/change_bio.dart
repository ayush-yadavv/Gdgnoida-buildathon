import 'package:eat_right/features/personalization/controllers/editform_update_controllers/change_bio_controller.dart';
          ...
          TextFormField(
            ...
            onChanged: (value) {
              if ('\n'.allMatches(value).length >= 18) {
                controller.bio.text = value.substring(
                  0,
                  value.lastIndexOf('\n'),
                );
              }
            ...
            decoration: const InputDecoration(
              labelText: 'Bio',
              hintText: 'tells Something about you!',
            ),
