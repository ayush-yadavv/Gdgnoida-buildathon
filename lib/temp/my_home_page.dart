...
//   final LogicController _logic = LogicController();
//   int _currentIndex = 0;
...
//     await _logic.captureImage(source: source, isFrontImage: true);
...
//                 duration: _duration,
//                 child: DailyIntakePage(dailyIntake: _logic.dailyIntake),
//               ),
//             ],
//           ),
//         ),
...
//                   children: [
//                     //    logic1 - no image
//                     if (_logic.frontImage.value != null)
//                       Stack(
//                         children: [
//                           ClipRRect(
//                             borderRadius: BorderRadius.circular(20),
//                             child: Image(
//                               image: FileImage(_logic.frontImage.value!),
//                             ),
//                           ),
//                           if (_logic.isLoading())
...
//             //  logic 1 - shimmer if logic controller is loading
//             if (_logic.isLoading()) const NutrientInfoShimmer(),

//             //iDk but it not owrk - Good/Moderate nutrients
//             if (_logic.goodNutrients().isNotEmpty)
//               Container(
...
//             //IDK NOT WOKR is this same as above - Bad nutrients
//             if (_logic.badNutrients().isNotEmpty)
//               Container(
//                 margin: const EdgeInsets.symmetric(vertical: 24.0),
//                 child: Column(
//                   crossAxisAlignment: CrossAxisAlignment.start,
...
//                       children: [
//                         Text(
//                           "Serving Size: ${_logic.servingSize().round()} g",
//                           style: TextStyle(
...
//                           setState: setState,
//                         ),
//                         CustomPortionButton(logic: _logic, setState: setState),
//                       ],
//                     ),
//                     const SizedBox(height: 16),
//                     Builder(
...
//                               ),
//                               Text(
//                                 "${_logic.sliderValue.toStringAsFixed(0)} grams, ${(_logic.getCalories() * (_logic.sliderValue / _logic.servingSize())).toStringAsFixed(0)} calories",
//                                 style: TextStyle(
//                                   fontSize: 12,
//                                   color:
//                                       Theme.of(context).colorScheme.onPrimary,
...
//             // llogi ccc 5555
//             if (_logic.servingSize() == 0 && _logic.parsedNutrients.isNotEmpty)
//               Padding(
//                 padding: const EdgeInsets.all(16.0),
//                 child: Column(
//                   children: [
...
//                         child: Slider(
//                           value: _logic.sliderValue.value,
//                           min: 0,
//                           max: _logic.servingSize(),
//                           onChanged: (newValue) {
//                             _logic.updateSliderValue(newValue);
//                           },
//                         ),
//                       ),
//                     if (_logic.servingSize() > 0)
...
//                       builder:
//                           (context) => AskAiPage(
//                             mealName: _logic.productName.value,
//                             foodImage: _logic.frontImage.value,
//                             logic: _logic,
//                           ),
//                     ),
//                   );
...
// //   const FoodScanPage({required this.logic, super.key});
...
// //                 child: Column(
// //                   children: [
//                  //   // if (widget.logic.foodImage.value != null)
// //                       Stack(
// //                         children: [
// //                           ClipRRect(
// //                             borderRadius: BorderRadius.circular(20),
// //                             child: Image(
// //                               image: FileImage(widget.logic.foodImage.value!),
// //                             ),
// //                           ),
// //                  //         if (widget.logic.isLoading())
// //                             const Positioned.fill(
// //                               left: 5,
// //                               right: 5,
// //                               top: 5,
...
// //                   ),
// //                   const SizedBox(height: 16),
// //                   ...widget.logic.analyzedFoodItems.map(
// //                     (item) => FoodItemCard(
// //                       item: item,
// //                       setState: setState,
// //                       logic: widget.logic,
...
//                   //         builder:
//                   //             (context) => AskAiPage(
//                   //               mealName: widget.logic.mealName.value,
//                   //               foodImage: widget.logic.foodImage.value!,
//                   //               logic: widget.logic,
//                   //             ),
//                   //       ),
//                   //     );
...
// //       if (mounted) {
// //         setState(() {
// //           widget.logic.foodImage.value = File(image.path);
// //         });
// //       }
// //       await widget.logic.analyzeFoodImage(
// //         imageFile: widget.logic.foodImage.value!,
// //         setState: (fn) {
// //           if (mounted) {
// //             setState(fn);
// //           }
...
// //   final LogicController logic = LogicController();
...
// //           logic.dailyIntake.value = dailyIntake;
...
// //             DateSelector(context, _selectedDate, (DateTime newDate) {
// //               setState(() {
