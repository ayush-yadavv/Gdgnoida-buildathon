...
//   static AnalysisController instance = Get.find();
...
//   // 5. AI Analysis
//   // Functions: analyzeImages, analyzeFoodImage, logMealViaText

//   // auxilairy controllers
...
//     final prompt = TextPart(AnalysisPrompts.analyseFoodImageV1);

//     //     final prompt0 = TextPart(
...
//           NutrientController.instance.totalPlateNutrients.value = {
...
//   //     dailyIntakeController.dailyIntake.forEach((key, value) {
//   //       updatedIntake[key] = (updatedIntake[key] ?? 0.0) + value;
//   //     });

//   //     await prefs.setString(storageKey, jsonEncode(updatedIntake));
//   //     dailyIntakeController.dailyIntake.value = updatedIntake;
//   //   } catch (e) {
...
//   Future<String> analyzeFoodViaText({required String foodItemsText}) async {
//     try {
//       isAnalyzing.value = true;
...
//         final totalPlateNutrients =
//             NutrientController.instance.totalPlateNutrients;
...
//     final prompt = TextPart(AnalysisPrompts.analyseProductImagesV1);
...
//       productName.value = jsonResponse['product']['name'].toString();
//       nutritionAnalysis.value =
//           jsonResponse['nutrition_analysis'] as Map<String, dynamic>;
...
//       nutrientController.parsedNutrients.value =
...
//       nutrientController.goodNutrients.clear();
//       nutrientController.badNutrients.clear();
//       for (var nutrient in nutrientController.parsedNutrients) {
//         if (nutrient["health_impact"] == "Good" ||
//             nutrient["health_impact"] == "Moderate") {
//           nutrientController.goodNutrients.add(nutrient);
//         } else {
//           nutrientController.badNutrients.add(nutrient);
//         }
//       }
  //     } catch (e) {
