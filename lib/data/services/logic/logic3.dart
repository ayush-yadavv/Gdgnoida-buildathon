...
//   var mealName = ''.obs;
//   // final Rx<double> _sliderValue = 0.0.obs;
//   // double get sliderValue => _sliderValue.value;

//   void updateSliderValue(double value) {
//     sliderValue.value = value;

//     // Update nutrients based on new serving size
//     if (parsedNutrients.isNotEmpty) {
//       final ratio = value / servingSize();
//       updateNutrientsForServing(ratio);
//     }
//   }

//   void updateNutrientsForServing(double ratio) {
//     // Update each nutrient based on the serving size ratio
//     for (var nutrient in parsedNutrients) {
//       try {
//         if (nutrient.containsKey('quantity')) {
//           nutrient['quantity'] =
//               (nutrient['quantity'] as num).toDouble() * ratio;
//         }
//       } catch (e) {
//         print('Error updating nutrient ${nutrient['name']}: $e');
//         // Handle error case
//       }
//     }
//   }
...
//       dailyIntake.value = updatedIntake; // Update the current dailyIntake
...
//   bool canAnalyze() =>
//       frontImage.value != null && nutritionLabelImage.value != null;
