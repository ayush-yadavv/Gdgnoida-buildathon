...
class SColors {
  ...
  static const Color secondary = Color(0xFF85C124);
  static const Color accent = Color(0x49FF2A5C);
  // static const Color success = Color(0xFF4CAF50);

  //  Gradients Colors
  static const googleGeminiGradient1 = Color(0xFF1A73E8);
  static const googleGeminiGradient = LinearGradient(
    colors: [
      Color(0xFF1A73E8),
      Color(0xFF4FABFF),
      Color(0xFFAECBFA),
  ...
  static const eatRightAIGradient = LinearGradient(
    colors: [
      Color(0xFF1A73E8),
      Color(0xFF4FABFF),
      Color(0xFFAECBFA),
  ...
  static const Color linksColor = Color.fromARGB(255, 52, 37, 255);
}
